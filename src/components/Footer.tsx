    ...
    <footer className="glass text-white relative mt-24 pt-24 overflow-hidden border-t border-cyan-400/20">
      ...
      <div className="container mx-auto px-4 py-10 text-center relative z-10">
        ...
        <div className="flex justify-center space-x-8 mb-8">
          <a href="https://www.linkedin.com/in/harshit-gupta-ai-developer/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition neon-glow" aria-label="LinkedIn profile">
          ...
          <a href="https://github.com/HG-programer" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition neon-glow" aria-label="GitHub profile">
